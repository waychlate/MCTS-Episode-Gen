...
def get_min_ttc(obs, lane_id, num_lanes=4):
    ...
    # Select ONLY index 1 (current velocity state) instead of worst-case max across all speeds
...
while (episodes_saved < 1):
    ...
    print(f"Successfully saved episode_{current_ep:04d} in {minutes:01d}m {seconds:.2f}s | {1 - episodes_saved} left to go.")
